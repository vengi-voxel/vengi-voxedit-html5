...
function findWasmBinary() {
  return locateFile("vengi-voxedit.wasm");
}
...
var ___syscall__newselect = function(nfds, readfds, writefds, exceptfds, timeout) {
  ...
  try {
    ...
    HEAP32), ((readfds) >>> 2) >>> 0, "loading")] : 0), srcReadHigh = (readfds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((readfds) + (4)) >>> 2) >>> 0, "loading")] : 0);
    var srcWriteLow = (writefds ? (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), 
    HEAP32), ((writefds) >>> 2) >>> 0, "loading")] : 0), srcWriteHigh = (writefds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((writefds) + (4)) >>> 2) >>> 0, "loading")] : 0);
    var srcExceptLow = (exceptfds ? (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), 
    HEAP32), ((exceptfds) >>> 2) >>> 0, "loading")] : 0), srcExceptHigh = (exceptfds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((exceptfds) + (4)) >>> 2) >>> 0, "loading")] : 0);
    var dstReadLow = 0, dstReadHigh = 0;
    var dstWriteLow = 0, dstWriteHigh = 0;
    var dstExceptLow = 0, dstExceptHigh = 0;
    var allLow = (readfds ? (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), 
    HEAP32), ((readfds) >>> 2) >>> 0, "loading")] : 0) | (writefds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), ((writefds) >>> 2) >>> 0, "loading")] : 0) | (exceptfds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), ((exceptfds) >>> 2) >>> 0, "loading")] : 0);
    var allHigh = (readfds ? (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), 
    HEAP32), (((readfds) + (4)) >>> 2) >>> 0, "loading")] : 0) | (writefds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((writefds) + (4)) >>> 2) >>> 0, "loading")] : 0) | (exceptfds ? (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((exceptfds) + (4)) >>> 2) >>> 0, "loading")] : 0);
    ...
    for (var fd = 0; fd < nfds; fd++) {
      ...
      if (stream.stream_ops.poll) {
        ...
        if (timeout) {
          ...
          var tv_sec = (readfds ? (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), 
          HEAP32), ((timeout) >>> 2) >>> 0, "loading")] : 0), tv_usec = (readfds ? (growMemViews(), 
          HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((timeout) + (4)) >>> 2) >>> 0, "loading")] : 0);
    ...
    if (readfds) {
      (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), ((readfds) >>> 2) >>> 0, "storing")] = dstReadLow;
      (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((readfds) + (4)) >>> 2) >>> 0, "storing")] = dstReadHigh;
    }
    if (writefds) {
      (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), ((writefds) >>> 2) >>> 0, "storing")] = dstWriteLow;
      (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((writefds) + (4)) >>> 2) >>> 0, "storing")] = dstWriteHigh;
    }
    if (exceptfds) {
      (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), ((exceptfds) >>> 2) >>> 0, "storing")] = dstExceptLow;
      (growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((exceptfds) + (4)) >>> 2) >>> 0, "storing")] = dstExceptHigh;
    }
    return total;
  } catch (e) {
...
function __setitimer_js(which, timeout_ms) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(27, 0, 1, which, timeout_ms);
...
var __timegm_js = function(tmPtr) {
  tmPtr >>>= 0;
  var ret = (() => {
    var time = Date.UTC((growMemViews(), HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((tmPtr) + (20)) >>> 2) >>> 0, "loading")] + 1900, (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((tmPtr) + (16)) >>> 2) >>> 0, "loading")], (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((tmPtr) + (12)) >>> 2) >>> 0, "loading")], (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((tmPtr) + (8)) >>> 2) >>> 0, "loading")], (growMemViews(), 
    HEAP32)[SAFE_HEAP_INDEX((growMemViews(), HEAP32), (((tmPtr) + (4)) >>> 2) >>> 0, "loading")], (growMemViews(), 
...
function _fd_close(fd) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(84, 0, 1, fd);
  try {
    var stream = SYSCALLS.getStreamFromFD(fd);
    FS.close(stream);
    return 0;
...
function _fd_read(fd, iov, iovcnt, pnum) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(85, 0, 1, fd, iov, iovcnt, pnum);
  iov >>>= 0;
  iovcnt >>>= 0;
  pnum >>>= 0;
  try {
...
function _fd_seek(fd, offset, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(86, 0, 1, fd, offset, whence, newOffset);
...
function _fd_write(fd, iov, iovcnt, pnum) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(87, 0, 1, fd, iov, iovcnt, pnum);
  iov >>>= 0;
  iovcnt >>>= 0;
  pnum >>>= 0;
  try {
...
function _getaddrinfo(node, service, hint, out) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(88, 0, 1, node, service, hint, out);
  node >>>= 0;
  service >>>= 0;
  hint >>>= 0;
  out >>>= 0;
...
var ASM_CONSTS = {
  ...
  2359411: () => window.innerWidth,
  2359441: () => window.innerHeight
};
